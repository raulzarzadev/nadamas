import { updateAwardsEventResult } from '@/legasy/firebase/results'
import { removeEventResult } from '@/legasy/firebase/results'
import AWARDS, { TEST_AWARDS } from '@/legasy/src/CONSTANTS/AWARDS'
