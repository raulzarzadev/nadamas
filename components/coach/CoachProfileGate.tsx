      ...
      {showIncompleteNotice && (
        <div className="rounded-[var(--r-md)] border border-[var(--c-border)] bg-white p-6 shadow-[var(--shadow-sm)] sm:p-8">
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            ...
            {missing.includes('Lugar y horarios') && (
              <Link
                href="/coach/agenda"
                className="inline-flex items-center justify-center rounded-full border border-[var(--c-border)] px-5 py-2.5 text-sm font-semibold text-[var(--c-ocean)] transition hover:bg-[var(--c-surface)]"
              >
                Publicar mis horarios
              </Link>
            )}
          </div>
        </div>
