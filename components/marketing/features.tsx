...
export default function Features() {
  return (
    <section className="mx-auto max-w-[1180px] px-5 py-20 sm:px-8 lg:py-28">
      <div className="grid gap-8 lg:grid-cols-[minmax(280px,0.72fr)_minmax(0,1.28fr)] lg:gap-10">
        <div className="reveal  lg:pt-3">
        ...
        <div className="reveal grid gap-5 sm:grid-cols-2">
          <div
            className="relative flex min-h-[320px] flex-col justify-between overflow-hidden rounded-[34px] p-8 sm:col-span-2 sm:p-10"
          ...
          >
            ...
            <div className="relative">
              ...
              >
                Eliges coach, ves su agenda real y confirmas tu clase sin esperar una respuesta por
                mensaje. El horario se bloquea al instante.
              </p>
            </div>
            <div
            ...
            >
              {['Confirmación inmediata', 'Sin cadenas de WhatsApp', 'Recordatorios'].map((t) => (
                <span
                  key={t}
          ...
          >
            ...
            <p className="mt-3 text-[0.97rem] leading-relaxed" style={{ color: 'var(--c-text-2)' }}>
              Evaluación práctica y teórica antes de publicar. Cada perfil describe sus habilidades
              y cualidades, y puedes leer las valoraciones de otros nadadores.
            </p>
          </div>
          ...
          >
            ...
            <p className="mt-3 text-[0.97rem] leading-relaxed" style={{ color: 'var(--c-text-2)' }}>
              Pagas al reservar, sin transferencias sueltas ni cobros pendientes después de clase.
            </p>
          </div>

          <div className="grid gap-5 sm:col-span-2 lg:grid-cols-3">
            {[
              {
