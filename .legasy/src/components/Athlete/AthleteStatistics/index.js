import { getAthleteRecords, getRecords } from '@/legasy/firebase/records'
import { STYLES } from '@/legasy/src/CONSTANTS/SWIMMING_TESTS.js'
import { format } from '@/legasy/src/utils/Dates.js'
