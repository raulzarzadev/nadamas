import { getAttendanceDate, getMonthAttendance } from '@/legasy/firebase/attendance'
...
import useAthletes from '@/legasy/src/hooks/useAthletes'
import { dayLabels } from '@/legasy/src/utils/Dates'
