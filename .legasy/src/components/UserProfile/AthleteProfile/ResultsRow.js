import { deleteResult, deleteUserResult } from '@/legasy/firebase/results'
...
import { AddIcon, CloseIcon, TrashBinIcon } from '@/legasy/src/utils/Icons'
import { averageRecordSpeed } from '@/legasy/src/utils/Records'
